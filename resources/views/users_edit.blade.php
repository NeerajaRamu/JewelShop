...
<!--                    {{ route('users.edit', 'Supervisor') }}-->
                    <form class="form-horizontal" method="POST" action="{{ route('users.update', ['id' => $val->id]) }} ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" type="" class="form-control" name="password" value="" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" type="" class="form-control" name="confirm_password" value="" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control m-bot15" name="region_id">
                                    ...
                                    <option value="{{ $region->id }}" {{ $selectedRegion == $region->id ? 'selected="selected"' : '' }}>{{ $region->name }}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
